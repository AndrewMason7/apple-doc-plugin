export const formatInlineContent = (nodes) => {
...
export const formatContentNodes = (nodes) => {
    if (!nodes || !Array.isArray(nodes)) {
        return '';
    }
    const parts = [];
...
export const formatDeclaration = (sections) => {
...
export const formatDeprecation = (summary) => {
...
export const formatParameters = (sections) => {
    if (!sections || !Array.isArray(sections)) {
        return undefined;
    }
...
export const formatDiscussion = (sections) => {
    if (!sections || !Array.isArray(sections)) {
        return undefined;
    }
...
//# sourceMappingURL=docc-formatter.js.map
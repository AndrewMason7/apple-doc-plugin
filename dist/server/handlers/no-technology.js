...
export const buildNoTechnologyMessage = ({ client, state }) => async () => {
    ...
    const lines = [
        ...
        '',
        bold('📌 Context Guidance:', 'For unqualified symbol documentation lookups (e.g. `get_documentation({ "path": "View" })`), choosing a technology clarifies which framework to look in. Note: `search_symbols` is fully capable of searching across all Apple frameworks globally without selecting a technology.'),
        '',
